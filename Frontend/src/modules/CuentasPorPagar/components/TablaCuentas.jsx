...
const TablaCuentas = ({
  ...
  // Determina si se deben marcar todos o ninguno
  const allSelected = cuentas.length > 0 && selectedCuentas.length === cuentas.length;
  const indeterminate = selectedCuentas.length > 0 && selectedCuentas.length < cuentas.length;
    ...
    >
      <Table>
        <TableHead sx={{ backgroundColor: 'black' }}>
          <TableRow>
            {/* Columna para checkbox en cabecera */}
          ...
          {cuentas.map((c) => {
            ...
            return (
              ...
              >
                ...
                <TableCell align="right" style={{ color: '#007bff' }}>
                  {formatoMoneda(c.monto_transferencia)}
                </TableCell>
                <TableCell align="right" style={{ color: '#28a745' }}>
                  {formatoMoneda(c.monto_efectivo)}
                </TableCell>
