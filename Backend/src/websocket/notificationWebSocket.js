// =====================================================
// SERVIDOR WEBSOCKET PARA NOTIFICACIONES
// =====================================================
  ...
  async verifyClient(info) {
    try {
      ...
      try {
        ...
        // Intentar con el proyecto alternativo
        try {
          decodedToken = await verifyFirebaseTokenAlternative(token);
        } catch (altError) {
      ...
      const user = await prisma.user.findUnique({
        ...
        select: { id: true, email: true, name: true, firebase_uid: true }
      });
