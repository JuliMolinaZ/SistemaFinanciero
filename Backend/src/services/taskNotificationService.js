...
/**
 * Enviar notificación al creador cuando una tarea va a estado "review"
 */
const sendTaskReviewNotification = async (task, creator, assignee, project) => {
  try {
    ...
    const emailData = {
      to: creator.email,
      subject: `👀 Tarea lista para revisión: ${task.title}`,
      html: `
        <!DOCTYPE html>
        <html lang="es">
        <head>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="content">
              <div class="greeting">¡Hola ${creator.name}! 👋</div>
              <div class="intro-text">
                Una tarea que creaste está lista para tu revisión en el proyecto <strong>${project.nombre || project.name}</strong>.
              </div>
              
              <div class="review-alert">
                <h3>👀 ¡Tarea Lista para Revisión!</h3>
                <p>El usuario asignado ha completado el trabajo y necesita tu aprobación</p>
              </div>
              ...
              <div class="task-card">
                ...
                ${task.description ? `
                  <div style="margin-bottom: 20px; padding: 16px; background: rgba(245, 158, 11, 0.05); border-radius: 8px; border-left: 3px solid #f59e0b;">
                    <strong style="color: #1e293b;">Descripción:</strong><br>
                    <span style="color: #475569; line-height: 1.6;">${task.description}</span>
                  </div>
                ` : ''}
                ...
                <div class="task-info">
                  ...
                  <div class="info-row">
                    ...
                    <span class="info-value">${assignee.name}</span>
                  </div>
              ...
              <div class="cta-section">
                ...
                <div style="margin-top: 16px; font-size: 14px; color: #64748b;">
                  Haz clic para revisar y aprobar o solicitar cambios
                </div>
              </div>
            </div>
    ...
    console.error('❌ Error enviando notificación de revisión:', error);
  }
};
